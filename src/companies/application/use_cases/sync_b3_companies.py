...
class SyncB3CompaniesUseCase:
    ...
    def _map_b3_payload_to_entity(
        self, basic_info: Dict[str, Any], detailed_info: Dict[str, Any]
    ) -> Company:
        ...
        payload_data = {
            "ticker": detailed_info.get("issuingCompany")
            or basic_info.get("issuingCompany"),
            "cvm_code": str(basic_info.get("codeCVM")),
            "company_name": detailed_info.get("companyName")
            or basic_info.get("companyName"),
            ...
            "subsector": subsector,
            "segment": segment,
            "segment_eng": detailed_info.get("industryClassificationEng")
            or detailed_info.get("segmentEng"),
            ...
            "last_date": DateResilientParser.parse(
                detailed_info.get("lastDate"), "last_date", telemetry=self._telemetry
            ),
            ...
            or detailed_info.get("institutionCommon"),
            "main_registrar": detailed_info.get("mainRegistrar")
            ...
            "has_quotation": detailed_info.get(
                "hasQuotation", detailed_info.get("has_quotation")
            ),
            "has_emissions": detailed_info.get(
                "hasEmissions", detailed_info.get("has_emissions")
            ),
