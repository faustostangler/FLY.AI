...
def get_buckets(min_val: float = 1, max_val: float = 100, step: float = 0.1):
    ...
    return _mutmut_trampoline(
        x_get_buckets__mutmut_orig, x_get_buckets__mutmut_mutants, args, kwargs, None
    )


def x_get_buckets__mutmut_orig(
    min_val: float = 1, max_val: float = 100, step: float = 0.1
):
...
def x_get_buckets__mutmut_1(
    min_val: float = 2, max_val: float = 100, step: float = 0.1
):
    """Generates logarithmic buckets for Prometheus histograms.
...
def x_get_buckets__mutmut_2(
    min_val: float = 1, max_val: float = 101, step: float = 0.1
):
    """Generates logarithmic buckets for Prometheus histograms.
...
def x_get_buckets__mutmut_3(
    min_val: float = 1, max_val: float = 100, step: float = 1.1
):
    """Generates logarithmic buckets for Prometheus histograms.
