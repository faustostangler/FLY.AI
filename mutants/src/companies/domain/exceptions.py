...
class CompanyDataValidationError(CompanySyncError):
    ...
    def __init__(self, message: str, field: str, ticker: Optional[str] = None):
        ...
        return _mutmut_trampoline(
            object.__getattribute__(
                self, "xǁCompanyDataValidationErrorǁ__init____mutmut_orig"
            ),
            object.__getattribute__(
                self, "xǁCompanyDataValidationErrorǁ__init____mutmut_mutants"
            ),
            args,
            kwargs,
            self,
    ...
    def xǁCompanyDataValidationErrorǁ__init____mutmut_orig(
        self, message: str, field: str, ticker: Optional[str] = None
    ):
        super().__init__(message)
        self.field = field
        self.ticker = ticker

    def xǁCompanyDataValidationErrorǁ__init____mutmut_1(
        self, message: str, field: str, ticker: Optional[str] = None
    ):
        super().__init__(None)
        self.field = field
    ...
    def xǁCompanyDataValidationErrorǁ__init____mutmut_2(
        self, message: str, field: str, ticker: Optional[str] = None
    ):
        super().__init__(message)
        self.field = None
    ...
    def xǁCompanyDataValidationErrorǁ__init____mutmut_3(
        self, message: str, field: str, ticker: Optional[str] = None
    ):
        super().__init__(message)
        self.field = field
    ...
    xǁCompanyDataValidationErrorǁ__init____mutmut_orig.__name__ = (
        "xǁCompanyDataValidationErrorǁ__init__"
    )
