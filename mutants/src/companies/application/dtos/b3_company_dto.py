...
class B3CompanyPayloadDTO(BaseModel):
    ...
    def to_domain(self) -> Company:
        ...
        return _mutmut_trampoline(
            object.__getattribute__(
                self, "xǁB3CompanyPayloadDTOǁto_domain__mutmut_orig"
            ),
            object.__getattribute__(
                self, "xǁB3CompanyPayloadDTOǁto_domain__mutmut_mutants"
            ),
            args,
            kwargs,
            self,
    ...
    xǁB3CompanyPayloadDTOǁto_domain__mutmut_orig.__name__ = (
        "xǁB3CompanyPayloadDTOǁto_domain"
    )
