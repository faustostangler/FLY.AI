...
def get_company_repository(db: Session = Depends(get_db)) -> PostgresCompanyRepository:
    ...
    return _mutmut_trampoline(
        x_get_company_repository__mutmut_orig,
        x_get_company_repository__mutmut_mutants,
        args,
        kwargs,
        None,
    )
...
def x_get_company_repository__mutmut_orig(
...
def x_get_company_repository__mutmut_1(
    db: Session = Depends(get_db),
) -> PostgresCompanyRepository:
    """Dependency Provider for CompanyRepository Port"""
...
def get_b3_data_source(
    ...
    kwargs = {}  # type: ignore
    return _mutmut_trampoline(
        x_get_b3_data_source__mutmut_orig,
        x_get_b3_data_source__mutmut_mutants,
        args,
        kwargs,
        None,
    )
...
def x_get_b3_data_source__mutmut_orig(
    telemetry: TelemetryPort = Depends(get_telemetry_port),
) -> PlaywrightB3DataSource:
...
def x_get_b3_data_source__mutmut_1(
    telemetry: TelemetryPort = Depends(get_telemetry_port),
) -> PlaywrightB3DataSource:
    """Dependency Provider for B3DataSource Port. Default headless mode from settings."""
...
def get_sync_b3_companies_use_case(
    ...
    kwargs = {}  # type: ignore
    return _mutmut_trampoline(
        x_get_sync_b3_companies_use_case__mutmut_orig,
        x_get_sync_b3_companies_use_case__mutmut_mutants,
        args,
        kwargs,
        None,
    )
...
def x_get_sync_b3_companies_use_case__mutmut_1(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(
        data_source=None, repository=repository, telemetry=telemetry
    )
...
def x_get_sync_b3_companies_use_case__mutmut_2(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(
        data_source=data_source, repository=None, telemetry=telemetry
    )
...
def x_get_sync_b3_companies_use_case__mutmut_3(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(
        data_source=data_source, repository=repository, telemetry=None
    )
...
x_get_sync_b3_companies_use_case__mutmut_orig.__name__ = (
    "x_get_sync_b3_companies_use_case"
)
