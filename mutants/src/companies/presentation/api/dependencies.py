...
def get_sync_b3_companies_use_case(
    ...
    args = [data_source, repository]# type: ignore
    kwargs = {}# type: ignore
...
def x_get_sync_b3_companies_use_case__mutmut_1(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(data_source=None, repository=repository)
...
def x_get_sync_b3_companies_use_case__mutmut_2(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(data_source=data_source, repository=None)
...
def x_get_sync_b3_companies_use_case__mutmut_4(
    ...
    """Dependency Provider for the Sync Use Case"""
    return SyncB3CompaniesUseCase(data_source=data_source, )
