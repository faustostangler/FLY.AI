...
def test_b3_payload_contract():
    ...
    expected_payload = {
        ...
        "otherCodes": [{"code": "PETR3", "isin": "BRPETRACNOR9"}],
    }

    (
        pact.upon_receiving("a request for company details")
    ...
    use_case = SyncB3CompaniesUseCase(
        data_source=MagicMock(), repository=MagicMock(), telemetry=MagicMock()
    )
